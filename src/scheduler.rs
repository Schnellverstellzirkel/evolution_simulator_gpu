//! Spreads a generation's evaluations across the primary GPU, optional extra
//! GPUs, and CPU SIMD cores.
//!
...
impl Scheduler {
    ...
    /// (off by default; use `primary` or `off` for none), and a CPU engine with
